...
class STSSL(nn.Module):
    ...
    def forward(self, view1, graph, prompt=None, prompt_2=None):
        # if prompt:
        #     view1 = prompt.add(view1)
        repr1 = self.encoder(view1, graph)  # view1: n,l,v,c; graph: v,v
        if prompt:
            repr1 = prompt.add(repr1)
        ...
        # if prompt:
        #     view2 = prompt.add(view2)
        
        repr2 = self.encoder(view2, graph2)
        if prompt_2:
            repr2 = prompt_2.add(repr2)
        elif prompt:
            repr2 = prompt.add(repr2)
        return repr1, repr2
